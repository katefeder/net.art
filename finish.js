...
function log_off(){
	console.log("log off");
	document.getElementById("uppertext").innerHTML = "<b>Correct!</b><br>If you ever get a fake pop-up, including ones like scareware, " + 
...
//done
function no_comment(){
	document.getElementById("uppertext").innerHTML = "<b>Great job!</b><br>Cyberbullying is never okay, and can be just as harmful and malicious as any other form of bullying. "+
...
//done
function ignore(){
	document.getElementById("uppertext").innerHTML = "<b>Nice one!</b><br>Phishing scams are very common, and easy to spot if you know where to look. Phishing emails typically have: urgency, excuses, "+
...
function unbiased(){
	document.getElementById("uppertext").innerHTML = "<b>Perfect!</b><br>The domain suffixes .gov and .org represent government sites and non-profit organizations. Generally, these types of sites "+
...
function ending(){
	document.getElementById("uppertext").innerHTML = "<b>Congrats! You successfully made it through the day!</b><br>You were able to get through it by making smart choices about using social media and the internet. "+
...
function claim(){
	...
	document.getElementById("transitions").innerHTML = "Wait a minute...";
...
function backscen1(){
	document.getElementById("uppertext").innerHTML = "<b>Test your digital literacy skills!</b><br>Choose the safest and smartest option in each scenario to successfully get through the day!";
...
function cyberbully(){
	document.getElementById("uppertext").innerHTML = "";
	document.getElementById("transitions").innerHTML = "Hold on...";
...
function money(){
	document.getElementById("uppertext").innerHTML = "";
	document.getElementById("transitions").innerHTML = "Let's take a closer look...";
...
function biased(){
	document.getElementById("uppertext").innerHTML = "";
	document.getElementById("transitions").innerHTML = "Not so fast...";
